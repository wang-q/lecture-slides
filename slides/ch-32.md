...
## 32.1.1 环境与生态因子是两个重要的概念

\alert{环境}: 某一特定生物体以外的空间及直接和间接影响该生物生存的一切事物的总和.
...
## 32.1.2生物对生态因子的耐受性是有限度的

* 最小因子法则：指各种生物的生长速度受它所需的环境因素中最低量因素的限制。
* 耐受性法则：每一种生物对每一个环境因素都有一个能耐受范围。
    + 最适区、生理抑制区、不能耐受区。
    + 对同一生态因子，不同种类生物的耐受范围不同

---

![生物的耐受性限度图解（据Smith,1980）](ch-32.images/image2.png)
...
\begin{figure}
    ...
    \begin{minipage}[b]{.43\linewidth}
        \includegraphics{ch-32.images/image3.png}
        \subcaption{河谷网}
    \end{minipage}
    \hfill
    \centering
    \begin{minipage}[b]{.53\linewidth}
        \includegraphics{ch-32.images/image4.png}
        \subcaption{三角洲}
    \end{minipage}
    \caption{火星上的水}
\end{figure}
...
\begin{figure}
    ...
    \begin{minipage}[b]{.48\linewidth}
        \includegraphics{ch-32.images/image6.png}
        \subcaption{凤凰号}
    \end{minipage}
    \hfill
    \centering
    \begin{minipage}[b]{.48\linewidth}
        \includegraphics{ch-32.images/image5.png}
        \subcaption{冰的升华}
    \end{minipage}
    \caption{第一个直接证据}
\end{figure}
...
![机遇号和勇气号](ch-32.images/image7.png)
...
这打破了1976年7月20 日登陆火星的“海盗1号”登陆车创下的2245个火星日的存活纪录，它在1982年11月与地球失去了联系。
...
\begin{figure}
    \includegraphics{ch-32.images/image8.png}\\
    \vfill
    \includegraphics{ch-32.images/image9.png}
    \caption{1665年, 艾萨克·牛顿发现光的色散}
\end{figure}

---

![太阳辐射谱](ch-32.images/image10.png)
...
![植物的光补偿点示意图(Emberlin,1983)](ch-32.images/image11.png)
...
![地表所受的太阳辐射强度](ch-32.images/image12.png)
