...
![重组DNA技术](ch-23.images/DNA-recombination.jpg)
...
![Southern印迹](ch-23.images/Southern-blot.jpg)
...
1. PCR技术的基本原理. PCR反应过程:
    * 双链DNA变性 ($90\text{--}95\,^{\circ}\text{C}$) 成为单链DNA;
    * 引物复性 ($37\text{--}60\,^{\circ}\text{C}$) 同单链DNA互补序列结合;
    * DNA聚合酶催化 ($70\text{--}75\,^{\circ}\text{C}$) 使引物延伸.
