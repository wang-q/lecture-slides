...
risk = 1/10 of the remaining curve at month 1, 1/9 of the remaining curve at month 2 and so on)
...
```{r km_censor, fig.cap = 'KM - censored', ref.label='km', warning=F, echo=F, message=F}
```
