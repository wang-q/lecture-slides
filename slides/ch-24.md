...
![不同生物基因组碱基对数目比较](ch-24.images/image1.jpeg)

---

1. 基因组及基因组学
    + 基因组学
        - 研究生物体的基因和基因组的结构组成、稳定性和功能。
...
![真核生物基因结构](ch-24.images/image2.jpeg)
...
![5号染色体短臂缺失](ch-24.images/image3.png)

---

![21染色体三体](ch-24.images/image4.png)
...
![色盲症辨别](ch-24.images/image6.png)

---

![血友病遗传谱系](ch-24.images/image7.png)
...
\note{
2009年12月，桑格研究所在《自然》杂志上刊文宣布，他们率先在世界上破译了肺癌、皮肤癌和乳 腺癌的全部基因密码，
...
![MR Stratton et al. Nature 458, 719-724 (2009) ](ch-24.images/image9.png)
...
!["绘制"](ch-24.images/image10.jpeg)

---

![模板与测序室](ch-24.images/image11.jpeg)

---

![Electropherogram](ch-24.images/image12.png)

---

![Clusters, Storage](ch-24.images/image13.jpeg)

---

![贡献](ch-24.images/image14.png)
...
\begin{figure}
    \begin{minipage}[b]{.45\linewidth}
        \includegraphics{ch-24.images/image15.png}
    \end{minipage}
    \hfill
    \begin{minipage}[b]{.45\linewidth}
        \includegraphics{ch-24.images/image16.png}
    \end{minipage}
...
![Celera stock](ch-24.images/image17.png)

---

![HGP sequencing strategy](ch-24.images/image101.png)

---

![Celera assembly strategy](ch-24.images/image102.png)
...
\begin{figure}
    \begin{minipage}[b]{.45\linewidth}
        \includegraphics{ch-24.images/image18.png}
        \subcaption{Nature}
    \end{minipage}
    \hfill
    \begin{minipage}[b]{.45\linewidth}
        \includegraphics{ch-24.images/image19.png}
        \subcaption{Science}
    \end{minipage}
    \caption{基因组草图，2001}
\end{figure}
...
![全基因组测序的生物](ch-24.images/image20.png)
...
![测序能力的增长](ch-24.images/image24.png)

---

![Illumina](ch-24.images/image25.jpeg)

---

![比摩尔定律更快](ch-24.images/image27.png)

---

![千个基因组计划](ch-24.images/image28.png)
...
Dr. Hauser, Partner, Amadeus Capital Partners Ltd, is the first consumer to purchase Illumina's individual genome sequencing service.
...
\begin{figure}
    \begin{minipage}[b]{.45\linewidth}
        \includegraphics{ch-24.images/image29.png}
        \subcaption{脊椎动物}
    \end{minipage}
    \hfill
    \begin{minipage}[b]{.45\linewidth}
        \includegraphics{ch-24.images/image31.png}
        \subcaption{英国人健康计划}
    \end{minipage}\\
    \begin{minipage}[b]{\linewidth}
        \includegraphics{ch-24.images/image30.png}
        \subcaption{拟南芥}
    \end{minipage}%
    \caption{其它计划}
\end{figure}
...
![爆发性增长的数据量](ch-24.images/image32.png)
...
![国际肿瘤基因组计划](ch-24.images/image33.png)

---

![追踪罕见遗传疾病的致病基因](ch-24.images/image34.png)
...
![元基因组(metagenome)](ch-24.images/image35.jpeg)
