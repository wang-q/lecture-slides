...
\foreach \angle in {0,4,...,360}{
        \begin{tikzpicture}
            ...
            \begin{scope}[shift={(0,0)}]
                % wave
                \draw[TolDarkBlue] plot[smooth,samples=100,domain=\angle-360:\angle] (pi/180*\angle-pi/180*\x,{sin(\x)});
            ...
            \begin{scope}[shift={(0,-3)}]
                % wave
                \draw[TolDarkBrown] plot[smooth,samples=100,domain=\angle-360:\angle] (pi/180*\angle-pi/180*\x,{sin(\x)+1/3*sin(3*\x)});
            ...
            \begin{scope}[shift={(0,-6)}]
                % wave
                \draw[TolDarkGreen] plot[smooth,samples=100,domain=\angle-360:\angle] (pi/180*\angle-pi/180*\x,{sin(\x)+1/3*sin(3*\x)+1/5*sin(5*\x)});
            ...
            \begin{scope}[shift={(0,-9)}]
                % wave
                \draw[TolDarkPink] plot[smooth,samples=100,domain=\angle-360:\angle] (pi/180*\angle-pi/180*\x,{sin(\x)+1/3*sin(3*\x)+1/5*sin(5*\x)+1/7*sin(7*\x)});
